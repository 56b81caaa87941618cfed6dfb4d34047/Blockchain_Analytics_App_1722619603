...
*/
Vue.component("simple_hero_component_1722619606", {
    template: `
        <section id="hero-section" class="bg-gradient-to-br from-pink-500 to-purple-700 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg p-8">
